...
/*lv_timer_t *scroll_timer;  // Declare a global timer variable

void scrollAnswerText(lv_timer_t *timer) {
    lv_label_set_text(ui_answer, lv_label_get_text(ui_answer) + 1);  // Scroll one line down
}*/
...
lv_obj_set_style_bg_color(ui_questionBox, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_border_color(ui_questionBox, lv_color_hex(0x0000ff), LV_PART_SCROLLBAR | LV_STATE_DEFAULT );
...
lv_label_set_text(ui_question,"INFINITEX");
...
lv_obj_set_width( ui_answeBox, 260);
lv_obj_set_height( ui_answeBox, 170);
lv_obj_set_x( ui_answeBox, 8 );
lv_obj_set_y( ui_answeBox, 50 );
...
lv_obj_set_style_bg_color(ui_answeBox, lv_color_hex(0x29AB87), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_answeBox, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_border_color(ui_answeBox, lv_color_hex(0x29AB87), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_border_opa(ui_answeBox, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_border_color(ui_answeBox, lv_color_hex(0x29AB87), LV_PART_SCROLLBAR | LV_STATE_DEFAULT );
lv_obj_set_style_border_opa(ui_answeBox, 255, LV_PART_SCROLLBAR| LV_STATE_DEFAULT);

ui_answer = lv_label_create(ui_answeBox);
lv_obj_set_width( ui_answer, 210);
lv_obj_set_height( ui_answer, 80);
lv_label_set_text(ui_answer,"HELLO! HOW CAN I HELP YOU?");
lv_label_set_long_mode(ui_answer,LV_LABEL_LONG_SCROLL);
lv_obj_set_style_text_color(ui_answer, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
/*scroll_timer = lv_timer_create(scrollAnswerText, 1000, NULL);  // Adjust the interval as needed
lv_timer_start(scroll_timer);*/
...
lv_obj_set_x( ui_stratButton, 2 );
lv_obj_set_y( ui_stratButton, -95);
